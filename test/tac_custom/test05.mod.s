...
foo:
    ...
    addl    $4, %esp               
    movl    %eax, -48(%ebp)        
    movl    -44(%ebp), %eax         #   8:     add    t5 <- t3, t4
    movl    -48(%ebp), %ebx        
    addl    %ebx, %eax             
    movl    %eax, -52(%ebp)        
    movl    8(%ebp), %eax           #   9:     add    t6 <- G, t5
    movl    -52(%ebp), %ebx        
    addl    %ebx, %eax             
    movl    %eax, -56(%ebp)        
    ...
    addl    $8, %esp               
    movl    %eax, -60(%ebp)        
    movl    $1, %eax                #  13:     mul    t8 <- 1, t7
    movl    -60(%ebp), %ebx        
    imull   %ebx                   
    movl    %eax, -64(%ebp)        
    movl    -64(%ebp), %eax         #  14:     add    t9 <- t8, 2
    movl    $2, %ebx               
    addl    %ebx, %eax             
    movl    %eax, -68(%ebp)        
    movl    -68(%ebp), %eax         #  15:     mul    t10 <- t9, 4
    movl    $4, %ebx               
    imull   %ebx                   
    movl    %eax, -24(%ebp)        
    movl    12(%ebp), %eax          #  16:     param  0 <- H
    pushl   %eax                   
    call    DOFS                    #  17:     call   t11 <- DOFS
    addl    $4, %esp               
    movl    %eax, -28(%ebp)        
    movl    -24(%ebp), %eax         #  18:     add    t12 <- t10, t11
    movl    -28(%ebp), %ebx        
    addl    %ebx, %eax             
    movl    %eax, -32(%ebp)        
    movl    12(%ebp), %eax          #  19:     add    t13 <- H, t12
    movl    -32(%ebp), %ebx        
    addl    %ebx, %eax             
    movl    %eax, -36(%ebp)        
    movl    -56(%ebp), %edi        
    movl    (%edi), %eax            #  20:     assign @t13 <- @t6
    movl    -36(%ebp), %edi        
    movl    %eax, (%edi)           
